    ...
    <div class="mx-auto pt-10 pb-20 w-11/12 md:w-2/3">
      ...
      <div>
        ...
        <div class="mt-8 w-2/3 tabs">
          <a href="{{ route('account.information', $user->id) }}" class="tab tab-lifted grow bg-[#FAFAF5] border border-1 text-lg border-[#EBEBEB]">
              投稿一覧
          </a>
          <a href="{{ route('account.information.favorite', $user->id) }}" class="tab tab-lifted grow bg-[#FFFFFF] border border-1 border-gray-300 text-lg font-semibold">
              お気に入り一覧
          </a>
        </div>
