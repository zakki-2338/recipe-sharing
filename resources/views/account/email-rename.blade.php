    ...
    <form method="post" action="{{ route('email.update') }}">
      ...
      @method('patch')
        ...
        <div class="mt-10 w-1/2 mx-auto flex flex-col items-center">
          ...
          <h1 class="underline underline-offset-2 text-xl">メールアドレス変更</h1>
          
          <div>
            <div class="mt-8">          
              <label for="current_email" class="label">
            ...
            <div class="mt-8">
              ...
              <input type="text" name="new_email" class="input border border-1 border-gray-300" required autofocus autocomplete="email" />
            </div>
          </div>
